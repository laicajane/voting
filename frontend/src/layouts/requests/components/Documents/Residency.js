...
export default function Residency({REQUESTOR, CAPTAIN, OFFICIALS}) {
      return (
            <Document title="Barangay Residency" wrap>
                  ...
                  <View wrap style={styles.header}>
                        ...
                        <Text style={[styles.h2, {marginTop: '50pt', marginBottom: '40pt', fontWeight: 700}]}>CERTIFICATE OF RESIDENCY</Text>
                  </View>     
                  <View style={styles.section}>
                        ...
                        <Text style={styles.p}>
                              ...
                              </Text> and a Filipino citizen a bonafide resident of Barangay San Jose, Sogod, Southern Leyte. 
                        </Text>
                        
                        <Text style={styles.p}>
                              <Text style={[{fontWeight: 700}]}>THIS CERTIFICATION </Text>
                              is hereby issued upon the request of the aforemention for {REQUESTOR.purpose} only.
                        </Text>
                        <Text style={styles.p}>
