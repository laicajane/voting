...
function AdminCoverLayout({ color, header, title, description, image, children }) {
  return (
    <PageLayout>
              ...
              <SoftBox pt={2} px={3}>
                {!header ? (
                  <>
                    ...
                    <SoftTypography pt={2} mb={0} variant="h5" fontWeight="bold" color="success" textGradient>
                        {description}
                      </SoftTypography>
                  </>
                ) : (
...
export default AdminCoverLayout;
