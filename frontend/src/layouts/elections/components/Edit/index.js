...
function Edit({FROM, POLL, POSITIONS, HandleRendering, UpdateLoading}) {
                              ...
                              <SoftBox component="form" role="form" className="px-md-0 px-2" onSubmit={handleSubmit}>
                                    ...
                                    <Grid container spacing={0} alignItems="center">
                                          <Grid item xs={12} sm={6} md={4} lg={3} px={1}>
                                                ...
                                                <input 
                                                      ...
                                                      type="date" 
                                                      disabled = {currentDate >= formData.application_start}
                                                />
                                          </Grid>
                                          <Grid item xs={12} sm={6} md={4} lg={3} px={1}>
                                    ...
                                    <Grid container spacing={10} alignItems="center">
                                          ...
                                          <Grid item xs={12} md={6} lg={4} px={1}>
                                                ...
                                                <SoftInput name="position1" value={formData.position1.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 2:</SoftTypography>
                                                <SoftInput name="position2" value={formData.position2.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 3:</SoftTypography>
                                                <SoftInput name="position3" value={formData.position3.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 4:</SoftTypography>
                                                <SoftInput name="position4" value={formData.position4.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 5:</SoftTypography>
                                                <SoftInput name="position5" value={formData.position5.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                          </Grid>
                                          }
                                          {showMore > 1 &&
                                          <Grid item xs={12} md={6} lg={4} px={1}>
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 6:</SoftTypography>
                                                <SoftInput name="position6" value={formData.position6.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 7:</SoftTypography>
                                                <SoftInput name="position7" value={formData.position7.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 8:</SoftTypography>
                                                <SoftInput name="position8" value={formData.position8.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 9:</SoftTypography>
                                                <SoftInput name="position9" value={formData.position9.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 10:</SoftTypography>
                                                <SoftInput name="position10" value={formData.position10.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                          </Grid>
                                          }
                                          {showMore > 2 &&
                                          <Grid item xs={12} md={6} lg={4} px={1}>
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 11:</SoftTypography>
                                                <SoftInput name="position11" value={formData.position11.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 12:</SoftTypography>
                                                <SoftInput name="position12" value={formData.position12.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 13:</SoftTypography>
                                                <SoftInput name="position13" value={formData.position13.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 14:</SoftTypography>
                                                <SoftInput name="position14" value={formData.position14.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                                <SoftTypography variant="button" className="me-1 text-nowrap my-auto">Position 15:</SoftTypography>
                                                <SoftInput name="position15" value={formData.position15.toUpperCase()} onChange={handleChange} size="small" disabled = {currentDate >= formData.application_start}/> 
                                          </Grid>
                                          }
                                    </Grid> 
                                    <SoftBox mt={2} display="flex" justifyContent="start">
                                          <SoftButton onClick={toggleShowLess} variant="gradient" disabled={showMore <= 1 ||  currentDate >= formData.application_start} className="mx-2 text-xxs px-3 rounded-pill" size="small" color="secondary">
                                                Show Less
                                          </SoftButton>
                                          <SoftButton onClick={toggleShowMore} variant="gradient" disabled={showMore >= 3 || currentDate >= formData.application_start} className="mx-2 text-xxs px-3 rounded-pill" size="small" color="info">
                                                Add More
                                          </SoftButton>
                                    </SoftBox>
