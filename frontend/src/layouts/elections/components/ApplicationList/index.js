...
import List from "layouts/elections/components/ApplicationList/List";

function ApplicationList({authUser, FROM, INFO, HandleRendering}) {
  const currentFileName = "layouts/elections/components/ApplicationList/index.js";
